...
const studyRecordDefault = {
  s: {
    lines: ["a", "k", "s", "t", "n", "h", "m", "y", "r", "w", "-"],
    a: {
      0: { correct: 0, wrong: 0, hesitate: 0 },
      1: { correct: 0, wrong: 0, hesitate: 0 },
      2: { correct: 0, wrong: 0, hesitate: 0 },
      3: { correct: 0, wrong: 0, hesitate: 0 },
      4: { correct: 0, wrong: 0, hesitate: 0 },
    },
    k: {
      0: { correct: 0, wrong: 0, hesitate: 0 },
      1: { correct: 0, wrong: 0, hesitate: 0 },
